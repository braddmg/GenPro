...
```
## Fastqc 
#Fastqc es un programa que sirve para evaluar la calidad de las secuencias.
#Vamos a utilizar un loop para procesar todas las secuencias en un sólo comando.
```yaml
